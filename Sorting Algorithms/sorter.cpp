...
int main(int argc, char* argv[])  { 
    ...
    // } 
    // PLACE YOUR CODE HERE: 
    if (sort_name == "BubbleSort") BubbleSort(items, 0, size - 1);
    else if (sort_name == "InsertionSort") InsertionSort(items, 0, size - 1);
    else if (sort_name == "MergeSort") MergeSort(items, 0, size - 1);
    else if (sort_name == "IterativeMergeSort") IterativeMergeSort(items, 0, size - 1);
    else if (sort_name == "QuickSort") QuickSort(items, 0, size - 1);
    else if (sort_name == "ShellSort") ShellSort(items, 0, size - 1);
    else {
